...
class HadesControlNetManager:
    ...
    def create_depth_map_simple(self, width=1024, height=1024, character_type="character"):
        ...
        print(f"🗺️  Criando depth map para {character_type}")
    ...
    def create_character_controls(self):
        ...
        print("🎬 CRIANDO CONTROLES PARA PERSONAGENS HADES-EGÍPCIO")
        print("=" * 55)
        ...
        for char_name, char_type, pose_type in characters:
            ...
            try:
                ...
                print(f"✅ {char_name} - Controles criados")
                
            except Exception as e:
                print(f"❌ {char_name} - Erro: {e}")
                results.append({
                    "character": char_name,
                    "success": False,
                    "error": str(e)
